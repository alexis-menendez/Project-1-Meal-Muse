...
document.addEventListener('DOMContentLoaded', () => {
    ...
    recipeForm.addEventListener('submit', async function (event) {  // Changed to `async` to handle image file
        ...
        // **Photo Input: Get the file input for the recipe photo (commented out because we are not using photo upload feature rigjt now)**
        ...
        // **Photo Handling: Convert the uploaded image to Base64 if a file is selected (commented out because we are not using photo upload feature rigjt now)**
        /*
        ...
        */
        ...
        const recipe = {
            ...
            // photo: photoData // ** Store the photo data as a Base64 string in the recipe object (commented out because we are not using photo upload feature rigjt now)**
        };
    ...
    /*
    // **Function to Read the File as Base64 String (commented out because we are not using photo upload feature rigjt now)**
